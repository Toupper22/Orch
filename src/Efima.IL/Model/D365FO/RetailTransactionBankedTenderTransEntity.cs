...
/// </summary>
[Entity("TransactionBankedTenderTrans", EntitySingularName = "TransactionBankedTenderTrans",
    EntityCachePersistence = EntityCachePersistence.MessageWidePersistent)]
[EntityPackage("Banked tender transactions.xml", "", "", "RetailTransactionBankedTenderTransEntity")]
public class RetailTransactionBankedTenderTransEntity : Entity
{
    ...
    public string RetailChannelId
    {
        get => GetFieldValue<string>(nameof(RetailChannelId));
        set => SetFieldValue(nameof(RetailChannelId), value);
    }
